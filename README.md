...
I build practical tools that combine web development, desktop apps, browser automation, APIs, data processing and applied AI.
...
### [MB Digital Tech](https://github.com/refreshmeat/MBdigitaltech)
Institutional and commercial website with forms, transactional email flow and continuous integration.

**Stack:** Next.js, React, TypeScript and GitHub Actions.
